    ...
    <>
      ...
      <header className="absolute top-0 left-0 right-0 z-20 px-6 py-6 md:px-12 md:py-8 ">
        <nav className="flex items-center justify-between max-w-7xl  mx-auto">
          <Link
            href="/"
            className="font-display text-xl md:text-2xl text-white drop-shadow-md"
          >
            Craigs Creations
          </Link>

          <ul className="hidden md:flex items-center gap-8 text-sm text-white drop-shadow-md">
            <li><Link href="/portfolio" className="hover:text-terracotta transition-colors:">Portfolio</Link></li>
